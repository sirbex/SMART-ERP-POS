...
const POSScreenAPI: React.FC = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 h-full bg-qb-gray-50">
          ...
          <CardHeader className="pb-3 border-b border-qb-gray-200 sticky top-0 z-10 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80">
            ...
            <div className="flex gap-2 mt-3">
              <div className="relative flex-1">
                ...
                <Input
                  ref={searchInputRef}
                  className="pl-10 qb-input bg-qb-gray-50 border-qb-gray-200 focus:bg-white focus:ring-2 focus:ring-blue-500 focus:outline-none"
      ...
      <div className="flex flex-col lg:w-2/5 h-full overflow-hidden">
        <Card className="qb-card flex flex-col h-full bg-white overflow-hidden">
          <CardHeader className="pb-2 sm:pb-3 px-3 sm:px-4 border-b border-qb-gray-200 sticky top-0 z-10 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80 shrink-0">
            <div className="flex justify-between items-center">
              <CardTitle className="text-base sm:text-lg font-semibold text-qb-gray-900 flex items-center gap-1.5 sm:gap-2">
                <ShoppingCart className="h-4 w-4 sm:h-5 sm:w-5 text-qb-blue-500" />
              ...
              <div className="flex gap-1 sm:gap-2">
                ...
                <Button 
                  variant="outline"
                  size="sm"
                  className="qb-btn-secondary text-[10px] sm:text-xs h-7 sm:h-8 px-1.5 sm:px-3"
                ...
                >
                  ...
                  <span className="hidden sm:inline">Held ({heldSalesCount})</span>
                  <span className="sm:hidden">({heldSalesCount})</span>
                </Button>
                <Button 
                  variant="outline" 
                  size="sm" 
              ...
              {selectedCustomer ? (
                ...
                <>
                  <div className="relative flex-1">
                    ...
                    <Input
                      className="pl-10 qb-input bg-qb-gray-50 focus:ring-2 focus:ring-blue-500 focus:outline-none"
          ...
          <CardContent className="flex-1 py-4 overflow-y-auto overflow-x-hidden scrollbar-thin">
            {cartItems.length === 0 ? (
              ...
              <div className="space-y-2">
                {cartItems.map((item, index) => {
                  ...
                  return (
                    <div key={item.id} className={`border border-qb-gray-200 rounded-lg hover:border-qb-blue-300 transition-colors bg-white ${index === selectedCartIndex ? 'ring-2 ring-qb-blue-300 border-qb-blue-300' : ''}`} onClick={() => setSelectedCartIndex(index)}>
                      {/* Main row with product info and controls */}
                      <div className="flex flex-col sm:flex-row sm:items-start justify-between p-2 sm:p-3 gap-2 sm:gap-4">
                        {/* Product name and price */}
                        <div className="flex-1 min-w-0">
                          <p className="font-medium text-qb-gray-900 text-sm truncate mb-0.5">{item.name}</p>
                          <p className="text-xs text-qb-gray-500">
                            {formatCurrency(item.price || 0)} per {item.unit}
                          </p>
                        </div>
                        
                        {/* UoM Selector - responsive positioning */}
                        ...
                        {/* Quantity controls, price, and delete */}
                        <div className="flex items-center justify-between sm:justify-start gap-2 shrink-0">
                          <div className="flex items-center gap-1">
                            <Button 
                              size="icon" 
                              variant="outline" 
                              className="h-7 w-7 sm:h-8 sm:w-8 hover:bg-qb-blue-50 hover:border-qb-blue-300"
                              onClick={() => updateQuantity(index, item.quantity - 1)}
                            >
                              <Minus className="h-3 w-3" />
                            </Button>
                            <Input
                              className="w-12 sm:w-14 h-7 sm:h-8 text-center text-xs sm:text-sm font-medium border-qb-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                              type="number"
                              step="0.01"
                              value={item.quantity}
                          ...
                          <div className="w-20 sm:w-24 text-right font-semibold text-qb-gray-900 text-xs sm:text-sm">
                            {formatCurrency(
                          ...
                          <Button 
                            size="icon" 
                            variant="ghost" 
                            className="h-7 w-7 sm:h-8 sm:w-8 text-qb-red-600 hover:bg-qb-red-50"
                      ...
                      <div className="px-2 sm:px-3 pb-2 sm:pb-3 pt-2 border-t border-qb-gray-100">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                          <div className="flex gap-1.5 sm:gap-2 flex-wrap items-center">
                            <Button size="sm" variant="outline" className="h-6 sm:h-7 text-[10px] sm:text-xs px-2" onClick={() => openPriceOverride(index)}>
                              Override Price
                            </Button>
                            <Button size="sm" variant="outline" className="h-6 sm:h-7 text-[10px] sm:text-xs px-2" onClick={() => openDiscountDialog(index)}>
                              Discount
                            </Button>
                            <label className="flex items-center gap-1 text-[10px] sm:text-xs text-qb-gray-700 select-none">
                              <input
                                type="checkbox"
                          ...
                          <div className="text-[10px] sm:text-xs text-qb-gray-600 whitespace-nowrap">
          ...
          <CardFooter className="flex-col pt-3 sm:pt-4 pb-3 sm:pb-4 bg-qb-gray-50 border-t border-qb-gray-200 sticky bottom-0 z-10 shadow-[0_-4px_10px_-6px_rgba(0,0,0,0.15)]">
            {/* Totals Summary */}
        ...
        <DialogContent className="max-w-[95vw] sm:max-w-sm w-[95vw] sm:w-auto max-h-[90vh] overflow-y-auto rounded-none sm:rounded-lg p-4 sm:p-6">
          ...
          <div className="space-y-3">
            <div>
              ...
              <Input id="newPrice" type="number" step="0.01" value={priceDialog.newPrice} onChange={(e) => setPriceDialog((s) => ({ ...s, newPrice: e.target.value }))} className="focus:ring-2 focus:ring-blue-500 focus:outline-none" />
            </div>
            <div>
              <Label htmlFor="priceReason">Reason</Label>
              <Input id="priceReason" placeholder="e.g., Manager approval" value={priceDialog.reason} onChange={(e) => setPriceDialog((s) => ({ ...s, reason: e.target.value }))} className="focus:ring-2 focus:ring-blue-500 focus:outline-none" />
            </div>
          </div>
          <DialogFooter>
        ...
        <DialogContent className="max-w-[95vw] sm:max-w-sm w-[95vw] sm:w-auto max-h-[90vh] overflow-y-auto rounded-none sm:rounded-lg p-4 sm:p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <Input autoFocus type="number" step="0.01" placeholder={discountDialog.mode === 'percent' ? 'e.g., 5' : 'e.g., 2.50'} value={discountDialog.value} onChange={(e) => setDiscountDialog((s) => ({ ...s, value: e.target.value }))} className="focus:ring-2 focus:ring-blue-500 focus:outline-none" />
            </div>
            <div>
              <Label htmlFor="discReason">Reason (required if &gt;5%)</Label>
              <Input id="discReason" value={discountDialog.reason} onChange={(e) => setDiscountDialog((s) => ({ ...s, reason: e.target.value }))} className="focus:ring-2 focus:ring-blue-500 focus:outline-none" />
            </div>
          </div>
          <DialogFooter>
                  ...
                  <div key={idx} className={`p-3 rounded border ${idx === selectedPaymentIndex ? 'border-blue-500 ring-2 ring-blue-200' : 'border-border'}`} onClick={() => setSelectedPaymentIndex(idx)}>
                    <div className="grid grid-cols-1 sm:grid-cols-12 gap-2 items-center">
                      ...
                      <div className="sm:col-span-4">
                        ...
                        <Input autoFocus={idx === 0} type="number" step="0.01" inputMode="decimal" value={p.amount ?? 0} onChange={(e)=>{
                      ...
                      <div className="sm:col-span-3">
                        ...
                        <Input placeholder={p.method?.includes('money')? 'Txn Ref (6+ chars)' : 'Ref / Auth Code'} value={p.reference || ''} onChange={(e)=> setPayments((list)=> balancePayments(list.map((it,i)=> i===idx? { ...it, reference: e.target.value }: it)))} className="focus:ring-2 focus:ring-blue-500 focus:outline-none" />
                      </div>
