...
import { CheckCircle2, XCircle, Download, FileDown } from 'lucide-react';
import { exportBalanceSheetToPDF, exportBalanceSheetToCSV } from '@/utils/exportUtils';
      ...
      {report && (
        <div className="space-y-4">
          <div className="flex justify-end gap-2">
            <Button size="sm" variant="outline" onClick={() => exportBalanceSheetToPDF(report)}>
              <FileDown className="h-4 w-4 mr-2" />
              Export PDF
            </Button>
            <Button size="sm" variant="outline" onClick={() => exportBalanceSheetToCSV(report)}>
