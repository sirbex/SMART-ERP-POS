    ...
    <div className="p-6 space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              {topProducts.map((product: { name: string; quantity: number; revenue: number }, idx: number) => (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              {recentTransactions.map((txn: { id: string; customer: string; time: string; total: number; status: string }) => (
