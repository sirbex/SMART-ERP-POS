      ...
      <Card className="p-4">
        <Tabs defaultValue="profit-loss">
          ...
          <TabsContent value="cash-flow">
            <div className="text-sm text-muted-foreground p-4">Cash flow report coming soon...</div>
          </TabsContent>
          <TabsContent value="comparative">
            <div className="text-sm text-muted-foreground p-4">Comparative reports coming soon...</div>
          </TabsContent>
        </Tabs>
      </Card>
    </div>
