 ...
 */
export function calculateDisplayPrice(basePrice: number, productUoM: ProductUoM): number {
 ...
 */
export function validateUoMForProduct(product: ProductWithUoMs, uomId: string): boolean {
  const productUoM = product.productUoMs?.find((pu) => pu.uomId === uomId);
 ...
 */
export function getProductUoMById(product: ProductWithUoMs, uomId: string): ProductUoM | undefined {
 ...
 * @returns Formatted string like "UGX 5.50 / kg"
 */
