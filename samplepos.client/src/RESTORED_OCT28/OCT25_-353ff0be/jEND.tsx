  ...
  const exportSupplierHistory = async () => {
    ...
    try {
      ...
      if (histExportFormat === 'PDF') {
        const res = await api.get(`/suppliers/${selectedSupplier.id}/history/export/pdf`, { responseType: 'blob' });
        ...
        const res = await api.get(`/suppliers/${selectedSupplier.id}/history/export`, { responseType: 'blob' });
