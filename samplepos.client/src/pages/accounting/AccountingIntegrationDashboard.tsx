    ...
    <div className="p-4 lg:p-6 space-y-6">
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            <div className="bg-gray-50 p-4 rounded-lg min-w-0">
              ...
              <div className="text-base sm:text-2xl font-bold text-gray-900">{data.sales.totalSales}</div>
            </div>
            <div className="bg-green-50 p-4 rounded-lg min-w-0">
              <div className="text-sm text-green-600">Revenue</div>
              <div className="text-base sm:text-2xl font-bold text-green-700">{formatCurrency(data.sales.totalRevenue)}</div>
            </div>
            <div className="bg-orange-50 p-4 rounded-lg min-w-0">
              <div className="text-sm text-orange-600">Cost of Goods</div>
              <div className="text-base sm:text-2xl font-bold text-orange-700">{formatCurrency(data.sales.totalCOGS)}</div>
            </div>
            <div className="bg-blue-50 p-4 rounded-lg min-w-0">
              <div className="text-sm text-blue-600">Gross Profit</div>
              <div className="text-base sm:text-2xl font-bold text-blue-700">{formatCurrency(data.sales.totalProfit)}</div>
            </div>
            <div className="bg-purple-50 p-4 rounded-lg min-w-0">
              <div className="text-sm text-purple-600">Profit Margin</div>
              <div className="text-base sm:text-2xl font-bold text-purple-700">{data.sales.profitMargin.toFixed(1)}%</div>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="text-base sm:text-2xl font-bold text-purple-600">{data.chartOfAccounts.total}</div>
        ...
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="text-base sm:text-2xl font-bold text-blue-600">{formatCurrency(data.receivables.totalAmount)}</div>
            <div className="space-y-1 mt-2">
        ...
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="text-base sm:text-2xl font-bold text-orange-600">{formatCurrency(data.payables.totalAmount)}</div>
            <div className="space-y-1 mt-2">
              <p className="text-xs text-gray-600">
        ...
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="text-base sm:text-2xl font-bold text-green-600">{data.journalEntries.recentCount}</div>
            <div className="space-y-1 mt-2">
              <p className="text-xs text-gray-600">
                Last 30 days
              </p>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-gray-50 p-4 rounded-lg min-w-0">
              ...
              <div className="text-base sm:text-2xl font-bold text-gray-700">
            ...
            <div className={`p-4 rounded-lg min-w-0 ${data.trialBalance.isBalanced ? 'bg-green-50' : 'bg-red-50'}`}>
              ...
              <div className={`text-base sm:text-2xl font-bold ${data.trialBalance.isBalanced ? 'text-green-700' : 'text-red-700'}`}>
