...
export default function BalanceSheetPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      {data && (
        <div
          className={`rounded-lg border p-4 flex flex-col sm:flex-row items-center justify-between gap-4 ${
            data.isBalanced
            ...
            <div className="space-y-6">
              ...
              <div
                className={`rounded-lg px-4 py-3 flex justify-between items-center ${
                  data.isBalanced ? 'bg-green-600 text-white' : 'bg-red-600 text-white'
                }`}
              >
