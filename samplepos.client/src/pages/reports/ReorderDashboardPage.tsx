        ...
        <div className="border-b border-gray-200 flex overflow-x-auto">
          {TABS.map((tab) => {
            ...
            return (
              ...
              >
                {tab.label}
                <span className={`inline-flex items-center justify-center px-2 py-0.5 text-xs font-semibold rounded-full border ${
                  isActive ? tab.badgeColor : 'bg-gray-50 text-gray-500 border-gray-200'
                }`}>
                  {count}
                </span>
              </button>
          ...
          <div className="bg-blue-50 border-b border-blue-200 px-4 py-2 flex items-center justify-between">
            ...
            <button
              onClick={() => {
                ...
                const skus = items.map((i) => i.sku || i.name).join(', ');
                alert(`Generate PO for: ${skus}\n\n(PO creation integration coming soon)`);
              }}
