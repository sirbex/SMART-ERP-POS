...
Start-Process pwsh -ArgumentList "-NoExit", "-Command", "cd '$backendPath'; Write-Host '🔧 Backend API Server' -ForegroundColor Cyan; npm start"
...
Start-Process pwsh -ArgumentList "-NoExit", "-Command", "cd '$frontendPath'; Write-Host '⚛️  Frontend Dev Server' -ForegroundColor Cyan; npm run dev"
