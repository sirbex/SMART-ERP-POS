...
CREATE INDEX idx_dist_so_customer ON dist_sales_orders(customer_id);
CREATE INDEX idx_dist_so_status ON dist_sales_orders(status);
CREATE INDEX idx_dist_so_number ON dist_sales_orders(order_number);
...
CREATE INDEX idx_dist_sol_order ON dist_sales_order_lines(sales_order_id);
CREATE INDEX idx_dist_sol_product ON dist_sales_order_lines(product_id);
...
CREATE INDEX idx_dist_del_order ON dist_deliveries(sales_order_id);
CREATE INDEX idx_dist_del_customer ON dist_deliveries(customer_id);
CREATE INDEX idx_dist_del_status ON dist_deliveries(status);
...
CREATE INDEX idx_dist_dll_delivery ON dist_delivery_lines(delivery_id);
...
CREATE INDEX idx_dist_inv_customer ON dist_invoices(customer_id);
CREATE INDEX idx_dist_inv_order ON dist_invoices(sales_order_id);
CREATE INDEX idx_dist_inv_delivery ON dist_invoices(delivery_id);
CREATE INDEX idx_dist_inv_status ON dist_invoices(status);
...
CREATE INDEX idx_dist_il_invoice ON dist_invoice_lines(invoice_id);
...
CREATE INDEX idx_dist_rcpt_invoice ON dist_receipts(invoice_id);
CREATE INDEX idx_dist_rcpt_customer ON dist_receipts(customer_id);
...
CREATE INDEX idx_dist_dpc_invoice ON dist_down_payment_clearings(invoice_id);
CREATE INDEX idx_dist_dpc_deposit ON dist_down_payment_clearings(down_payment_id);
CREATE INDEX idx_dist_dpc_customer ON dist_down_payment_clearings(customer_id);
