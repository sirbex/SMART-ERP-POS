                  ...
                  {customerTransactions.length > 0 ? (
                    <div className="space-y-3">
                      <div className="text-sm font-medium text-muted-foreground">
                        Showing {customerTransactions.length} transaction{customerTransactions.length !== 1 ? 's' : ''}
                      </div>
                      
                      <div className="space-y-2">
                        {customerTransactions.map((transaction, txIdx) => (
                          <div key={txIdx} className="p-3 border rounded-lg hover:bg-muted/20 transition-colors">
