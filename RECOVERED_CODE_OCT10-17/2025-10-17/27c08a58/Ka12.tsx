...
import type { Supplier } from '../models/BatchInventory';
import type { 
  SupplierItem, 
    ...
    <div className="space-y-6 p-6">
      ...
      {selectedSupplierView && (
        <Dialog open={true} onOpenChange={() => setSelectedSupplierView(null)}>
          <DialogContent className="w-[95vw] sm:w-full sm:max-w-4xl lg:max-w-6xl xl:max-w-7xl max-h-[90vh] overflow-auto">
            <DialogHeader>
              <DialogTitle>
