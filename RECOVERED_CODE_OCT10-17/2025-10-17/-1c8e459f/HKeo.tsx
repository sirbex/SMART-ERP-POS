    ...
    <div className="min-h-screen bg-background p-2 sm:p-4 md:p-6">
      <div className="w-full mx-auto space-y-4 sm:space-y-6">
        ...
        <Dialog open={showHistory} onOpenChange={setShowHistory}>
          <DialogContent className="w-[95vw] sm:w-full sm:max-w-4xl lg:max-w-6xl max-h-[80vh] overflow-y-auto">
            <DialogHeader>
        ...
        <Dialog open={showCustomerDetail} onOpenChange={setShowCustomerDetail}>
          <DialogContent className="w-[95vw] sm:w-full sm:max-w-4xl lg:max-w-6xl xl:max-w-7xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
