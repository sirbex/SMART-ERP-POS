  ...
  return (
    <>
      ...
      <Button
        variant="ghost"
        size="icon"
        className="fixed bottom-4 right-4 z-50 lg:hidden bg-qb-blue-500 text-white hover:bg-qb-blue-600 shadow-lg rounded-full w-14 h-14"
      ...
      <aside className={`
        qb-sidebar fixed left-0 top-0 h-screen w-64 pt-16 overflow-y-auto z-50
