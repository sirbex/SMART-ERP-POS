...
export const SalesRegisterPage = () => {
  ...
  // Add product to cart (will be used when product search is implemented)
  ...
  // Demo: Add a sample product to test the cart (remove in production)
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex space-x-3">
            <button 
              ...
              className="flex items-center space-x-2 px-4 py-2 bg-teal-500 text-white border border-teal-600 rounded-lg hover:bg-teal-600 transition-colors"
            >
              <Plus className="w-4 h-4" />
              <span className="font-medium">Add Demo Item</span>
            </button>
