...
-- NOTE: SYSTEM supplier protection is enforced in the service layer
-- (supplierService.ts → assertNotSystemSupplier), NOT via database triggers.
-- This follows the project architecture: business logic belongs in services only.
