-- =============================================================================
-- Migration 202: Fix P&L Reconciliation Functions
-- =============================================================================
-- Fixes column reference bugs in 201_pnl_reconciliation.sql that were already
-- applied to tenant databases using incorrect PascalCase column names
-- (invoices."OutstandingBalance", invoices."Status") which do not exist in the
-- snake_case invoices schema. This migration re-applies all functions with the
-- correct column names (invoices.amount_due, invoices.status).
--
