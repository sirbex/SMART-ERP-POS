                    ...
                    <TableRow key={product.id}>
                      ...
                      <TableCell className="text-right">
                        <div className="flex flex-col items-end">
                          ...
                          {product.productUoMs && product.productUoMs.length > 0 && (
                            <span className="text-xs text-muted-foreground">
                              {product.productUoMs.map((pu: any) => {
                                const qty = Number(product.currentStock || 0) / Number(pu.conversionFactor);
                                return `${qty.toFixed(2)} ${pu.uom?.name || pu.uomId}`;
                              }).join(', ')}
                            </span>
                          )}
                        </div>
