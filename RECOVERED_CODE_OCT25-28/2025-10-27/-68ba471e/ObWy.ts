...
export interface SaleItem {
  ...
  discount?: number;
  discountReason?: string | null; // Reason for discount (required if >5%)
  priceOverride?: number | null; // Override price (10%-200% range)
  priceOverrideReason?: string | null; // Reason for price override
  subtotal?: number;
  tax?: number;
  lineTotal?: number;
