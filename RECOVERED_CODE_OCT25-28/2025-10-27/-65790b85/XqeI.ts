 ...
 * Handles both legacy and enhanced UoM systems with precision
 */
...
export function calculateUoMPrice(
  ...
  if (conversion.unitPrice !== undefined) {
    const totalPrice = conversion.unitPrice * quantity;
    return {
  ...
  if (basePrice !== undefined) {
    const unitPrice = basePrice * conversion.conversionFactor;
