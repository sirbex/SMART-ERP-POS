...
import { useSupplierSummaries } from '../services/api/suppliersApi';
...
const SupplierAccountsPayable: React.FC = () => {
  ...
  // Fetch supplier summaries (counts + aggregates) from backend
  const { data: suppliersData } = useSupplierSummaries();
