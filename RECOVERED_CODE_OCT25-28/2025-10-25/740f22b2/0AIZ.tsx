...
const StockValuationReport: React.FC = () => {
  ...
  const handleExport = () => {
    ...
    const headers = ['Product Name', 'Quantity', 'Unit Cost (₱)', 'Total Value (₱)'];
    ...
    <div className="space-y-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">
              ₱{valuation?.totalValue.toLocaleString('en-PH', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) || '0.00'}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-purple-600">
              ₱{valuation?.itemCount 
                ? (valuation.totalValue / valuation.itemCount).toLocaleString('en-PH', { minimumFractionDigits: 2, maximumFractionDigits: 2 })
                : '0.00'
              }
            </div>
            <p className="text-xs text-muted-foreground">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Products contributing most to total inventory value
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            ...
            <div className="space-y-2">
              {topProducts.map((product, index) => {
                const percentage = valuation ? (product.totalValue / valuation.totalValue) * 100 : 0;
                return (
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <span className="text-sm font-semibold text-green-600">
                          ₱{product.totalValue.toLocaleString('en-PH', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                        </span>
                      </div>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        {product.quantity.toFixed(2)} units × ₱{product.costPrice.toFixed(2)}
                      </p>
                    </div>
                  </div>
                );
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-right">
                      ...
                      <p className="text-lg font-semibold">
                        {valuation.products.reduce((sum, p) => sum + p.quantity, 0).toFixed(2)} units
                      </p>
                    </div>
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-lg font-bold text-green-600">
                        ₱{valuation.totalValue.toLocaleString('en-PH', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                      </p>
                    </div>
                  </div>
                </div>
