...
export function convertToBaseUnit(
  ...
  const quantityInBaseUnit = quantity * productUoM.conversionFactor;
...
export function calculatePriceForUoM(
  ...
  // Calculate unit price for this UoM
  // Unit price = (base price per base unit) × conversion factor × price multiplier
  const unitPrice = basePrice * productUoM.conversionFactor * productUoM.priceMultiplier;
