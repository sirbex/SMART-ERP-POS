...
describe('Product Zod Schemas', () => {
    ...
    describe('UnitOfMeasureEnum (dynamic, DB-backed)', () => {
        it('should accept any non-empty UoM string', () => {
            const validValues = ['PIECE', 'BOX', 'CARTON', 'KG', 'AMP', 'TUBE', 'CAPSULE', 'BARREL'];
        ...
        it('should reject empty string', () => {
            expect(UnitOfMeasureEnum.safeParse('').success).toBe(false);
        });
    });
