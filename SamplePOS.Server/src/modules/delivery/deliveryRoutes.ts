 ...
 */
router.post(
  '/orders/from-sale/:saleId',
  authenticate,
  requirePermission('delivery.create'),
  deliveryController.createDeliveryFromSale
);
...
router.get(
  ...
  deliveryController.getDeliverableSales
);
...
router.get(
  ...
  authenticate,
  requirePermission('delivery.read'),
  deliveryController.getDeliveryOrder
);
...
router.get(
  ...
  authenticate,
  requirePermission('delivery.read'),
  deliveryController.searchDeliveryOrders
);
...
router.post(
  ...
  authenticate,
  requirePermission('delivery.create'),
  deliveryController.createDeliveryRoute
);
...
router.get(
  ...
  authenticate,
  requirePermission('delivery.read'),
  deliveryController.searchDeliveryRoutes
);
