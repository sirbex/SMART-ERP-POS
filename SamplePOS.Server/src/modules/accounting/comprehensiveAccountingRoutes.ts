...
async function proxyToAccountingAPI(req: express.Request, res: express.Response, endpoint: string) {
  try {
    ...
    logger.error(
      'Error proxying to accounting API:',
...
router.patch(
  '/invoices/:id/void',
  requirePermission('accounting.void'),
  asyncHandler(async (req, res) => {
...
router.get(
  '/customer-payments/:id/allocations',
  requirePermission('accounting.read'),
  asyncHandler(async (req, res) => {
...
router.post(
  '/customer-payments/:id/auto-allocate',
  requirePermission('accounting.create'),
  asyncHandler(async (req, res) => {
...
router.get(
  '/supplier-payments/:id/allocations',
  requirePermission('accounting.read'),
  asyncHandler(async (req, res) => {
...
router.put(
  '/supplier-payment-allocations/:id',
  requirePermission('accounting.update'),
  asyncHandler(async (req, res) => {
