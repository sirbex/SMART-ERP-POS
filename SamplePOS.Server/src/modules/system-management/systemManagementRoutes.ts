 ...
 */
router.post('/backups/:id/verify', asyncHandler(async (req, res) => {
    const pool = req.tenantPool || globalPool;
    const { id } = req.params;
 ...
 */
router.post('/backups/cleanup', asyncHandler(async (req, res) => {
    const pool = req.tenantPool || globalPool;
 ...
 */
router.get('/maintenance-mode', asyncHandler(async (req, res) => {
    const pool = req.tenantPool || globalPool;
