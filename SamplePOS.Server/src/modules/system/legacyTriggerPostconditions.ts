...
/** [table_name, trigger_name] pairs that must be absent after each migration. */
export const LEGACY_TRIGGERS_BY_MIGRATION: Record<string, ReadonlyArray<readonly [string, string]>> = {
...
export async function legacyTriggersAbsentForMigration(
    pool: Pool,
    filename: string,
): Promise<boolean> {
