...
router.post('/journal-entries', async (req: Request, res: Response) => {
    try {
        ...
        return res.status(error.message?.includes('Period') ? 400 : 500).json({
            success: false,
...
router.post('/journal-entries/:id/reverse', async (req: Request, res: Response) => {
    try {
        ...
        logger.error('Failed to reverse journal entry', { id: req.params.id, error });
...
router.get('/journal-entries/:id', async (req: Request, res: Response) => {
    try {
        ...
        logger.error('Failed to get journal entry', { id: req.params.id, error });
        return res.status(500).json({
            success: false,
...
router.get('/periods', async (req: Request, res: Response) => {
    try {
        ...
        logger.error('Failed to list periods', { error });
        return res.status(500).json({
            success: false,
            error: error.message || 'Failed to list periods'
        });
    }
});
 ...
 */
router.get('/periods/check-open', async (req: Request, res: Response) => {
    try {
        ...
        logger.error('Failed to check period status', { error });
        return res.status(500).json({
            success: false,
            error: error.message || 'Failed to check period status'
        });
    }
});
 ...
 */
router.post('/periods/reopen', async (req: Request, res: Response) => {
    try {
 ...
 */
router.post('/periods/lock', async (req: Request, res: Response) => {
    try {
        ...
        logger.error('Failed to lock period', { error });
        return res.status(400).json({
            success: false,
 ...
 */
router.get('/periods/:year/:month/history', async (req: Request, res: Response) => {
    try {
        ...
        const period = periods.find((p: any) => p.periodYear === year && p.periodMonth === month);
        ...
        logger.error('Failed to get period history', { error });
        return res.status(500).json({
            success: false,
            error: error.message || 'Failed to get period history'
        });
    }
});
...
router.get('/reports/profit-loss', async (req: Request, res: Response) => {
    try {
        ...
        logger.error('Failed to generate GL-based P&L report', { error });
        return res.status(500).json({
            success: false,
 ...
 */
router.get('/reports/profit-loss/by-customer', async (req: Request, res: Response) => {
    try {
        const { dateFrom, dateTo } = req.query;
        ...
        logger.error('Failed to generate P&L by customer report', { error });
        return res.status(500).json({
            success: false,
            error: error.message || 'Failed to generate P&L by customer report'
        });
    }
});
 ...
 */
router.get('/reports/profit-loss/by-product', async (req: Request, res: Response) => {
    try {
        const { dateFrom, dateTo } = req.query;
        ...
        logger.error('Failed to generate P&L by product report', { error });
        return res.status(500).json({
            success: false,
            error: error.message || 'Failed to generate P&L by product report'
        });
    }
});
 ...
 */
router.get('/reports/profit-loss/verify', async (req: Request, res: Response) => {
    try {
        const { dateFrom, dateTo } = req.query;
        ...
        logger.error('Failed to verify P&L consistency', { error });
        return res.status(500).json({
            success: false,
            error: error.message || 'Failed to verify P&L consistency'
        });
    }
});
 ...
 */
router.get('/reports/profit-loss/comparative', async (req: Request, res: Response) => {
    try {
        ...
        logger.error('Failed to generate comparative P&L report', { error });
        return res.status(500).json({
            success: false,
            error: error.message || 'Failed to generate comparative P&L report'
        });
    }
});
...
router.get('/reconciliation/summary', async (req: Request, res: Response) => {
    try {
        ...
        return res.status(500).json({
            success: false,
            error: error.message || 'Failed to get reconciliation summary'
        });
    }
});
 ...
 */
router.get('/reconciliation/cash', async (req: Request, res: Response) => {
    try {
        const { asOfDate } = req.query;
        ...
        logger.error('Failed to reconcile cash', { error });
        return res.status(500).json({
            success: false,
            error: error.message || 'Failed to reconcile cash'
        });
    }
});
 ...
 */
router.get('/reconciliation/accounts-receivable', async (req: Request, res: Response) => {
    try {
        const { asOfDate } = req.query;
        ...
        logger.error('Failed to reconcile AR', { error });
        return res.status(500).json({
            success: false,
            error: error.message || 'Failed to reconcile AR'
        });
    }
});
 ...
 * Reconcile Inventory
 */
router.get('/reconciliation/inventory', async (req: Request, res: Response) => {
    try {
        const { asOfDate } = req.query;
 ...
 */
router.get('/reconciliation/accounts-payable', async (req: Request, res: Response) => {
    try {
        const { asOfDate } = req.query;
        ...
        logger.error('Failed to reconcile AP', { error });
        return res.status(500).json({
            success: false,
            error: error.message || 'Failed to reconcile AP'
        });
    }
});
 ...
 */
router.get('/reconciliation/:accountCode/discrepancies', async (req: Request, res: Response) => {
    try {
        ...
        logger.error('Failed to get discrepancy details', { accountCode: req.params.accountCode, error });
        return res.status(500).json({
            success: false,
            error: error.message || 'Failed to get discrepancy details'
        });
    }
});
